...
type EssentialRetailHeaderProps = {
...
const EssentialRetailHeaderFields: YextFields<EssentialRetailHeaderProps> =
  {
    section: {
      label: "Section",
      type: "object",
...
const EssentialRetailHeaderComponent: PuckComponent<
  EssentialRetailHeaderProps
> = (props) => {
  ...
  const renderUtilityIcon = ({
    ...
    return (
      <div style={wrapperStyle}>
        <Image image={iconImage} className="h-full w-full" style={imageStyle} />
      </div>
    );
  };
  ...
  return (
    ...
    >
      ...
      >
        <style>{headerLinkTypographyStyles}</style>
...
export const EssentialRetailHeader: YextComponentConfig<EssentialRetailHeaderProps> =
  {
    label: "Header",
    fields: EssentialRetailHeaderFields,
    defaultProps: {
    ...
    render: (props) => (
      <AnalyticsScopeProvider
        name={`EssentialRetailHeader${getAnalyticsScopeHash(props.id)}`}
      >
        <EssentialRetailHeaderComponent {...props} />
      </AnalyticsScopeProvider>
    ),
  };

export const config: SectionConfig = {
  id: "EssentialRetailHeader",
  displayName: "Header",
  description: "Header",
